...
//maak gebruik van nodes om een lijst te vormen
// tweede versie is met arrays
	 ...
	 * @post The size of the list equals its old size plus one.
	 ...
	 * 		@ Arrays.equals(getElements(), 0, index, old(getElements()), 0, index)
	 * @post The elements at the indices grater than the given index equal the elements at the positions + 1 of the new list.
	 * 		| Arrays.equals(getElements(), index+1, getSize(), old(getElements()), index, old(getSize()))
	 * @post The element at the given index equals the fiven value.
